...
- Automations/scripts/scenes: `get_automation`, `create_automation`, `set_automation`, `update_automation`, `patch_automation`, `rename_automation`, `duplicate_automation`, `delete_automation`, `automation_control`, `trigger_automation`, `enable_automation`, `disable_automation`, `reload_automations`, `automation_diagnostics`, `list_automation_configs`, `get_automation_config`, `list_script_configs`, `get_script_config`, `set_script`, `update_script`, `delete_script`, `list_scene_configs`, `get_scene_config`, `set_scene`, `update_scene`, `delete_scene`, `list_traces`, `get_trace`, `list_trace_contexts`, `get_automation_traces`
...
- Storage and registries: `list_storage_keys`, `list_storage_keys_filtered`, `read_storage_key`, `read_storage_key_window`, `search_storage_key`, `search_storage_json`, `read_storage_json_path`, `read_storage_json_paths`, `patch_storage_json_path`, `write_storage_key`, `delete_storage_key`, `backup_storage_key`, `list_registries`, `read_registry`, `search_registry`, `get_registry_entry`, `create_registry_entry`, `replace_registry_entry`, `patch_registry_entry`, `delete_registry_entry`, `search_entity_registry`, `get_entity_registry_entry`, `search_device_registry`, `search_config_entries`, `get_config_entry`, `patch_config_entry`, `search_area_registry`, `search_floor_registry`, `search_label_registry`, `search_category_registry`, `patch_entity_registry_entry`, `patch_device_registry_entry`
